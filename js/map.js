...
// Задаем константы
var HOUSE_AVATAR = ['img/avatars/user01.png', 'img/avatars/user02.png', 'img/avatars/user03.png', 'img/avatars/user04.png', 'img/avatars/user05.png', 'img/avatars/user06.png', 'img/avatars/user07.png', 'img/avatars/user08.png'];
...
// Координта по Y
var locationY = randomInteger(Y_MIN, Y_MAX);
...
var similarCardTemplate = document.querySelector('#card')
    ...
    var renderCard = function (card) {
      ...
      cardElement.querySelector('.popup__text--time').innerHTML = ;
      return cardElement;
    }
